...
//
// ESPEJO en trainer-app/src/lib/bibliotecaRank.ts — mismos casos de test.
...
export function rankLibrary<T extends RankeableLib>(items: T[], query: string, miCoachId?: string | null): T[] {

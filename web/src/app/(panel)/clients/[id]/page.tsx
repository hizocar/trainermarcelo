    ...
    ? await supabase
        ...
        .select(`
          ...
          exercises (
            ...
            ref_weight, order_index, rest_seconds, target_rir, target_pct_1rm, target_rpe, target_pct_fcmax, tempo, notes, video_url, archived, volume_type, intensity_types,
            superseries_group,
            exercise_series ( id, exercise_id, series_number, reps_objective, rest_seconds, tempo, target_rir, target_rpe, target_pct_1rm, target_pct_fcmax, ref_weight, set_type )
          )
        `)
